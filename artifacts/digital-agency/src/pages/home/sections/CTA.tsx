    ...
    <section id="contact" className="py-28 sm:py-36 bg-[#fafbfc] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-5xl relative z-10">
        ...
        >
          ...
          <motion.div
            className="absolute top-12 left-12 sm:left-16 text-white/5 group-hover:text-white/8 pointer-events-none z-0 rotate-[15deg] transition-colors duration-300 will-change-transform"
            animate={floatAnimation(10, 4.2, 0.1)}
          >
            <Instagram className="w-12 h-12 sm:w-16 sm:h-16" />
          </motion.div>
          <motion.div
            className="absolute bottom-16 left-8 sm:left-12 text-white/5 group-hover:text-white/8 pointer-events-none z-0 rotate-[-12deg] transition-colors duration-300 will-change-transform"
            animate={floatAnimation(8, 3.8, 0.5)}
          >
            <Facebook className="w-10 h-10 sm:w-12 sm:h-12" />
          </motion.div>
          <motion.div
            className="absolute top-16 right-12 sm:right-20 text-white/5 group-hover:text-white/8 pointer-events-none z-0 rotate-[-8deg] transition-colors duration-300 will-change-transform"
            animate={floatAnimation(12, 4.5, 0.2)}
          >
            <Linkedin className="w-12 h-12 sm:w-16 sm:h-16" />
          </motion.div>
          <motion.div
            className="absolute bottom-20 right-8 sm:right-16 text-white/5 group-hover:text-white/8 pointer-events-none z-0 rotate-[10deg] transition-colors duration-300 will-change-transform"
            animate={floatAnimation(9, 3.5, 0.7)}
          >
            <Youtube className="w-12 h-12 sm:w-14 sm:h-14" />
          </motion.div>
          <motion.div
            className="absolute top-[35%] left-[25%] text-white/[0.03] pointer-events-none z-0 rotate-[-20deg] hidden md:block will-change-transform"
            animate={floatAnimation(6, 4.0, 0.3)}
          >
            <Megaphone className="w-8 h-8" />
          </motion.div>
          <motion.div
            className="absolute bottom-[30%] right-[25%] text-white/[0.03] pointer-events-none z-0 rotate-[18deg] hidden md:block will-change-transform"
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            {/* Title with Fuchsia-to-White gradient */}
            <h2 className="text-3xl sm:text-5xl lg:text-6xl font-serif font-black text-white mb-6 tracking-tight leading-[1.1] select-text">
              ...
              <span className="bg-gradient-to-r from-fuchsia-300 via-purple-100 to-white bg-clip-text text-transparent">Digital Competition?</span>
            </h2>
